...
-- ===========================================
-- Seed: EXTREME challenges (the hardest tier; difficulty = EXTREME)
-- Endpoint lists carry explicit expectStatus so the black-box HTTP suite
-- is deterministic. Reference solutions live in /examples (perfect + imperfect).
-- ===========================================
INSERT INTO challenges (title, slug, description, difficulty, category_id, max_score, time_limit_minutes, created_by, origin, featured, times_attempted, times_completed, average_score, xp_reward, required_endpoints, hints, learning_objectives) VALUES
(
  ...
  'EXTREME', 4, 1000, 90, 3, 'COMMUNITY', TRUE, 9, 1, 410.00, 400,
...
(
  ...
  'EXTREME', 8, 1000, 90, 3, 'COMMUNITY', FALSE, 7, 0, 0.00, 400,
...
(
  ...
  'EXTREME', 3, 1000, 90, 3, 'COMMUNITY', FALSE, 6, 0, 0.00, 400,
...
(
  ...
  'EXTREME', 9, 1000, 90, 3, 'COMMUNITY', FALSE, 5, 0, 0.00, 400,
...
(
  ...
  'EXTREME', 5, 1000, 90, 3, 'COMMUNITY', FALSE, 8, 1, 395.00, 400,
