...
-- created_by resolves profoak if present, else NULL (column is nullable) to avoid FK errors.
--
...
(
  ...
  'EXTREME', 4, 1000, 90, (SELECT id FROM users WHERE username = 'profoak'), 'COMMUNITY', TRUE, 9, 1, 410.00, 400,
...
(
  ...
  'EXTREME', 8, 1000, 90, (SELECT id FROM users WHERE username = 'profoak'), 'COMMUNITY', FALSE, 7, 0, 0.00, 400,
...
(
  ...
  'EXTREME', 3, 1000, 90, (SELECT id FROM users WHERE username = 'profoak'), 'COMMUNITY', FALSE, 6, 0, 0.00, 400,
...
(
  ...
  'EXTREME', 9, 1000, 90, (SELECT id FROM users WHERE username = 'profoak'), 'COMMUNITY', FALSE, 5, 0, 0.00, 400,
...
(
  ...
  'EXTREME', 5, 1000, 90, (SELECT id FROM users WHERE username = 'profoak'), 'COMMUNITY', FALSE, 8, 1, 395.00, 400,
